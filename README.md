...
- reusable RTC fast-lane impairment fixture under `testkit/` for validating
  repair without granting the reliable duplicate an artificial zero-latency path
...
labels and legacy browser globals remain stable. Reliable duplicate repair is
now part of this shared transport authority; performance telemetry remains a
separate concern with its own acceptance criteria.
